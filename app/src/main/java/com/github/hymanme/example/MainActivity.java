...
//            }
//        });
        mTagFlowLayout.setSelectedListener(new OnTagSelectedListener() {
            @Override
            public void selected(View view, int position, List<TagBean> selected) {
                Toast.makeText(MainActivity.this, "selected" + position, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void unSelected(View view, int position, List<TagBean> selected) {
                Toast.makeText(MainActivity.this, "unSelected" + position, Toast.LENGTH_SHORT).show();
            }
        });
...
//                mTagFlowLayout.setCanScroll(canScroll = !canScroll);
        ...
        sb_max_height.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mTagFlowLayout.setMaxVisibleHeight(-1);
            }
        ...
        cb_scrollable.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mTagFlowLayout.setForceFixed(isChecked);
            }
        });
    }
    ...
    class MyTagAdapter extends TagAdapter<TagBean> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            MutSelectedTagView textView = new MutSelectedTagView(MainActivity.this);
